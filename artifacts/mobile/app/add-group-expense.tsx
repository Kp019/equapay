...
export default function AddGroupExpenseScreen() {
  ...
  const paidByName = useMemo(() => {
    return group?.members.find((m) => m.id === paidById)?.name ?? "";
  }, [group, paidById]);
      ...
      >
        ...
        <View style={styles.form}>
          ...
          {splitType === "equal" && totalAmount > 0 && (
            ...
            >
              <Text style={[styles.splitSummaryText, { color: colors.primary }]}>
                Each person pays{" "}
              ...
              <View style={{ gap: 8 }}>
                {group.members.map((m) => (
                  <View key={m.id} style={styles.customRow}>
                    <Text
                      style={[styles.customMemberName, { color: colors.foreground }]}
                    >
                      {m.id === userId ? "You" : m.name}
                    </Text>
                    <TextInput
                ...
                {totalAmount > 0 && (
                  ...
                  >
                    {customTotal.toFixed(2)} / {totalAmount.toFixed(2)} assigned
                  </Text>
                )}
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  memberChipText: { fontSize: 14, fontFamily: "Inter_500Medium" },
  categoryGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
  ...
  splitSummaryText: { fontSize: 14, fontFamily: "Inter_500Medium" },
  customRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
